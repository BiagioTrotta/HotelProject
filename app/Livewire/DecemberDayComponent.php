...
class DecemberDayComponent extends Component
{
    public $room_id;
    public $user_id;
    public $start_day;
    ...
    {   
        ...
        $december = December_day::findOrFail($this->room_id);

        $december->update($this->user_id);
    ...
    public function update()
{
    ...
    // Trova il record December_day specifico in base a room_id
    $december = December_day::findOrFail($this->room_id);
    ...
    {
        $data = December_day::all();
        $users = User::all();

        return view('livewire.december-day-component');
    }
