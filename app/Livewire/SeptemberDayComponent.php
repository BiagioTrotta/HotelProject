...
class SeptemberDayComponent extends Component
{
    public $room_id;
    public $user_id;
    public $start_day;
    ...
    public function update2()
    {
        ...
        $august = September_day::findOrFail($this->room_id);
    ...
    public function update()
    {
        ...
        // Trova il record September_day specifico in base a room_id
        $august = September_day::findOrFail($this->room_id);
    ...
    {
        $data = September_day::all();
        $users = Client::all();

        return view('livewire.september-day-component');
    }
