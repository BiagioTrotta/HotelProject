...
class FebruaryDayComponent extends Component
{
    ...
    {   
        ...
        $august = February_day::findOrFail($this->room_id);
    ...
    public function update()
{
    ...
    {
        $data = February_day::all();
        $users = User::all();

        return view('livewire.february-day-component');
    }
}
