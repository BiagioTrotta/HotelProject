...
class OctoberDayComponent extends Component
{
    ...
    {   
        ...
        $october = October_day::findOrFail($this->room_id);

        $october->update($this->user_id);
    ...
    public function update()
{
    ...
    // Trova il record October_day specifico in base a room_id
    $october = October_day::findOrFail($this->room_id);
    ...
    {
        $data = October_day::all();
        $users = User::all();

        return view('livewire.october-day-component');
    }
