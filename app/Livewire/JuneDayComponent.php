...
class JuneDayComponent extends Component
{
    public $room_id;
    public $user_id;
    public $start_day;
    ...
    {   
        ...
        $june = June_day::findOrFail($this->room_id);

        $june->update($this->user_id);
    ...
    public function update()
{
    ...
    // Trova il record june_day specifico in base a room_id
    $june = June_day::findOrFail($this->room_id);
    ...
    public function render()
    {
        $data = June_day::all();
        $users = User::all();
        return view('livewire.june-day-component');
    }
